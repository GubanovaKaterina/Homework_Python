...
2. В отчете Allure вы увидите:
   ...
   - **Описание теста**: Тест проверяет корректность работу калькулятора с различными операциями.
   - **Шаги теста**:
   ...
   - **Название теста**: `Тестирование корзины магазина`.
   - **Описание теста**: Тест проверяет корректность оборажаемой суммы в корзине.
   - **Шаги теста**:
